...
from ..helpers.datetime_utils import str_to_localized_datetime, datetime_to_local_str, amend_timestamp
        ...
        self.endpoint_filter_criteria = [
            {
                ...
                "operator": "AFTER",
                "value": amend_timestamp(datetime_to_local_str(str_to_localized_datetime(
