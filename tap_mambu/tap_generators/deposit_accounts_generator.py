...
from ..helpers.datetime_utils import datetime_to_utc_str, str_to_localized_datetime, amend_timestamp
        ...
        self.endpoint_filter_criteria = [
            {
                "field": "lastModifiedDate",
                "operator": "AFTER",
                "value": amend_timestamp(datetime_to_utc_str(str_to_localized_datetime(
